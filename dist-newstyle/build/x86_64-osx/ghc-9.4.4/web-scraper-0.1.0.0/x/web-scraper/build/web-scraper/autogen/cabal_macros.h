...
/* package web-scraper-0.1.0.0 */
#ifndef VERSION_web_scraper
#define VERSION_web_scraper "0.1.0.0"
#endif /* VERSION_web_scraper */
#ifndef MIN_VERSION_web_scraper
#define MIN_VERSION_web_scraper(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_web_scraper */
...
/* package http-client-tls-0.3.6.2 */
#ifndef VERSION_http_client_tls
#define VERSION_http_client_tls "0.3.6.2"
...
#define CURRENT_COMPONENT_ID "web-scraper-0.1.0.0-inplace-web-scraper"
